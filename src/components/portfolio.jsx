                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Projet 1</h2>
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-aguadeluz">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Projet 2</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            My Meetic
                          </span>{" "}
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-todo">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Projet 3</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            My Twitter
                          </span>
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-medlingos">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Projet 4</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            Site web du taff
                          </span>
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-smth">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Projet 5</h2>
                        <div className="w-more">
                          <span className="w-ctegory">Projet bot wa du taff</span>
                        </div>
                      </div>
                      <div className="col-sm-4">
                        <div className="w-like">
